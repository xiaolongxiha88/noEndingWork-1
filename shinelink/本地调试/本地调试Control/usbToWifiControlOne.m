...
-(void)initUI{
    if (_controlType==1) {
            _nameArray=@[@"开关逆变器(0)",@"安规功能使能(1)",@"有功功率百分比(3)",@"容性载率(4)",@"感性载率(4)",@"容性PF(5)",@"感性PF(5)",@"PV电压(8)",@"选择通信波特率(22)",@"运行PF为1(89)",@"过频降额起点(91)",@"频率-负载限制率(92)",@"Q(v)无功延时(107)",@"过频降额延时(108)",@"Q(v)曲线Q最大值(109)",@"Island使能(230)",@"风扇检查(231)",@"电网N线使能(232)",@"N至GND监测功能使能(235)",@"非标准电网电压范围使能(236)",@"指定的规格设置使能(237)",@"MPPT使能(238)",@"电源启动/重启斜率(20/21)",@"Q(v)切出/切入高压(93/94)",@"Q(v)切出/切入低压(95/96)",@"Q(v)切入/切出功率(97/98)",@"无功曲线切入/切出电压(99/100)",@"检查固件1/2(233/234)",@"PF调整值(101~106)",@"PF限制负载百分比点1~4(110/112/114/116)",@"PF限制功率因数1~4(111/113/115/117)"];
    }
