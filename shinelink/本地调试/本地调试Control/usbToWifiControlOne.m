...
-(void)initUI{
    if (_controlType==1) {
            _nameArray=@[@"开关逆变器(0)",@"安规功能使能(1)",@"PF CMD记忆使能(2)",@"有功功率百分比(3)",@"无功功率百分比(4)",@"功率因数(5)",@"PV电压(8)",@"选择通信波特率(22)",@"设置PF模式(89)",@"过频降额起点(91)",@"频率-负载限制率(92)",@"Q(v)无功延时(107)",@"过频降额延时(108)",@"Q(v)曲线Q最大值(109)",@"Island使能(230)",@"风扇检查(231)",@"电网N线使能(232)",@"N至GND监测功能使能(235)",@"非标准电网电压范围使能(236)",@"指定的规格设置使能(237)",@"MPPT使能(238)",@"电源启动/重启斜率(20/21)",@"Q(v)切出/切入高压(93/94)",@"Q(v)切出/切入低压(95/96)",@"Q(v)切入/切出功率(97/98)",@"无功曲线切入/切出电压(99/100)",@"检查固件1/2(233/234)",@"PF调整值(101~106)",@"PF限制负载百分比点1~4(110/112/114/116)",@"PF限制功率因数1~4(111/113/115/117)"];
    }
    if (_controlType==2) {
  _nameArray=@[@"语言(15)",@"国家(16)",@"启动电压(17)",@"启动时间(18)",@"故障恢复后重启延迟时间(19)",@"通信地址(30)",@"系统时间(45~50)",@"系统一周(51)",@"AC电压10分钟保护值(80)",@"PV电压高故障(81)",@"Modbus版本(88)",@"PID工作模式(201)",@"PID开关(202)",@"PID工作电压(203)",@"逆变器模块(28~29)",@"逆变器经纬度(122/123)",@"AC1限制电压低/高(52/53)",@"AC1频率限制高/低(54/55)",@"AC2限制电压低/高(56/57)",@"AC2频率限制高/低(58/59)",@"AC3限制电压低/高(60/61)",@"AC3频率限制高/低(62/63)",@"并网电压限制低/高(64/65)",@"并网频率限制低/高(66/67)",@"AC电压限制时间1低/高(68/69)",@"AC电压限制时间2低/高(70/71)",@"AC频率限制时间1低/高(72/73)",@"AC频率限制时间2低/高(74/75)",@"AC电压限制时间3低/高(76/77)",@"AC频率限制时间3低/高(78/79)"];
    }
